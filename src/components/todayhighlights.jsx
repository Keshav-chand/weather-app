...
const TodayHighlights = ({ weatherData, airQualityData }) => {
  ...
  return (
    ...
    >
      <div style={{ fontSize: "20px", textAlign: "center" }}>Today's Highlights</div>
      ...
      <div
        style={{
          ...
          alignItems: "center", // Vertical alignment for the items
        }}
      >
        <div
          style={{
      ...
      <div
        style={{
          ...
          gap: "4px",
          marginTop: "10px",
          justifyContent: "center", // Center the highlights horizontally
        }}
      >
